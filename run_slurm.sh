...
cd /gpfs/work1/0/prjs1420/AUMC-Tile_Extractor
...
python /gpfs/work1/0/prjs1420/AUMC-Tile_Extractor/cli/preprocess_cli.py --config config/config12.yaml --processes 8
